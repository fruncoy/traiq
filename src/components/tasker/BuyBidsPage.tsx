...
const BuyBidsPage = () => {
  ...
  const handleBuyPackage = (pkg: BidPackage) => {
    toast.success(`Successfully purchased ${pkg.bids} bids`);
  };
  ...
  const handleBuyCustom = () => {
    ...
    toast.success(`Successfully purchased ${customBids} bids`);
  };
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button onClick={handleBuyCustom}>Buy Custom Package</Button>
          </div>
        </CardContent>
      </Card>
      </div>
